...
export class AppRoutes {
    ...
    static get routes(): Router {
        ...
        router.post('/api/productos', authMiddleware, requireAdmin, productoController.crearProducto);
        router.put('/api/productos/:id', authMiddleware, requireAdmin, productoController.actualizarProducto);
        router.delete('/api/productos/:id', authMiddleware, requireAdmin, productoController.eliminarProducto);
